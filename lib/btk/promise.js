...
//------------------------------------------------------------
// these are usefull for dealing with promise chains
//
function Result(source, value, params) {
	this.init(source, value, params);
};
exports.Result = Result;


Result.make = function(source, value, params) {
	return wrap(new Result(source, value, params));
};
...
(function(p){
	...
	p.init = function(source, value, params) {
		this.source = source;
		this.value  = value;
		this.params = params;
	};
...
Result.chain = function(chain, context, source, value, params) {
	Result.make(source, value, params).chain(chain, context);
};
